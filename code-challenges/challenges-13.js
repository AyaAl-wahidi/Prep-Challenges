...
const stringReverse = (str) => {
    let array = str.split(' ');
    const result = array.reduce((memory, current) => {
...
const statistics = (voters) => {
    return voters.reduce((result, voter) => {
        const { votes_To } = voter;
        result[votes_To] = (result[votes_To] || 0) + 1;
        return result;
    }, {});
};
// -------------------------------------------------------------------------------------------------------
